# -*- coding: utf-8 -*-
"""Yahoo_Finance_Scraper.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/anish045007/Python_Web_Sraper/blob/main/Yahoo_Finance_Scraper.ipynb

**Data Scraper**
1. Scrape Crude Oil (Ticket Name = "CL=F") Data from Yahoo Fimance from 1st Jan 2000 to 1st Sep 2023 with an interval of 1 Month
2. Convert it into a Data Frame
3. converting date in to index colum   
4. print the data using Tabulate
"""
...
1. drawing the sample of a specific year
2. claculating mean of price of crude oil in that year at closing price
...
# Filter the DataFrame for the specified date range (from January 2020 to September 2023)
filtered_data = df['2022-01-01':'2023-09-02']

# Plot the 'Close' prices within the specified date range
...
plt.title('Close Price of Crude Oil (Jan 2020 - Sep 2023)')
...
# Filter the DataFrame for the specified date range (from January 2022 to September 2023)
monthly_data_2022_2023 = df['2022-01-01':'2023-09-30']

# Resample the data to monthly frequency and calculate the mean for each month
monthly_mean = monthly_data_2022_2023['Close'].resample('M').mean()

# Plot the seasonal pattern
plt.figure(figsize=(12, 6))
plt.plot(monthly_mean, marker='o', linestyle='-')
plt.xlabel('Month')
plt.ylabel('Mean Close Price')
plt.title('Seasonal Pattern of Crude Oil Prices (Jan 2022 - Sep 2023)')
plt.grid(True)
...
# Define the ticker symbols for crude oil and S&P 500
crude_oil_ticker = 'CL=F'
sp500_ticker = '^GSPC'  # Yahoo Finance symbol for S&P 500

# Set the date range for historical data
start_date = '2022-01-01'
end_date = '2023-09-02'

# Download historical data for crude oil and S&P 500
crude_oil_data = yf.download(crude_oil_ticker, start=start_date, end=end_date)
sp500_data = yf.download(sp500_ticker, start=start_date, end=end_date)

# Keep only the 'Adj Close' prices for both datasets
crude_oil_prices = crude_oil_data['Adj Close']
sp500_prices = sp500_data['Adj Close']

# Combine both datasets into a single DataFrame
df = pd.concat([crude_oil_prices, sp500_prices], axis=1)
df.columns = ['Crude Oil', 'S&P 500']

# Calculate the correlation coefficient
correlation_coefficient = df.corr().iloc[0, 1]

print(f"Correlation between Crude Oil and S&P 500: {correlation_coefficient:.3f}")

# Create a scatter plot
plt.figure(figsize=(8, 6))
sns.scatterplot(x='Crude Oil', y='S&P 500', data=df)
plt.title('Scatter Plot: Crude Oil vs. S&P 500')
